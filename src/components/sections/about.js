      ...
      <div className="inner">
        <StyledText>
          <div>
            ...
            <p>
              Fast-forward to today, and I own a{' '}
              <a href="https://discord.gg/vfqFtKvd">good discord server</a>,{' '}
            ...
            <p>
              I also am building an app by which one can theme their spotify just like {' '}
              <a href="https://github.com/khanhas/spicetify-cli/discussions/578">
                spicetify v2.
              </a>{' '}
